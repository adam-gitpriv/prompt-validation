# Prompt 1: Basic (Podstawowy)

**Wariant:** Tylko wynik badania, bez danych o użytkowniku
...
2. Kontekst - Wyjaśnij co oznacza wynik (BEZ diagnozy!)
3. Następny krok - Zaproponuj jedno konkretne działanie
