# Prompt 2: With Work (Z kontekstem zawodowym)

**Wariant:** Wynik badania + wiek, płeć, zawód
...
2. Kontekst zawodowy - Odnieś się do specyfiki pracy użytkownika
3. Wyjaśnienie - Co oznacza wynik (BEZ diagnozy!)
4. Następny krok - Zaproponuj jedno konkretne działanie

### Personalizacja zawodowa:
- Odnieś się do wyzwań typowych dla zawodu użytkownika
- Użyj języka odpowiedniego dla kontekstu pracy
- Zaproponuj rozwiązania dopasowane do stylu życia zawodowego
